...
function moduleBuild(args) {
  ...
  var tasks = [function (cb) {
    ...
    return runBabel('ES5', { copyFiles: copyFiles, outDir: _path2.default.resolve('lib'), src: src }, (0, _webpackMerge2.default)(buildConfig.babel, buildConfig.babelDev || {}, {
  ...
  if (userConfig.npm.esModules !== false) {
    tasks.push(function (cb) {
      return runBabel('ES6 modules', { copyFiles: copyFiles, outDir: _path2.default.resolve('es'), src: src }, (0, _webpackMerge2.default)(buildConfig.babel, buildConfig.babelDev || {}, {

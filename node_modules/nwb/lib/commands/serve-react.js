  ...
  if (args.force === true) {
    ...
    config.resolve = {
      alias: {
        ...
        'react': _path2.default.dirname(_resolve2.default.sync('react/package.json', { basedir: process.cwd() })),
        'react-dom': _path2.default.dirname(_resolve2.default.sync('react-dom/package.json', { basedir: process.cwd() }))
      }
    };
  }
...
function serveReact(args, cb) {
  ...
  (0, _runSeries2.default)([function (cb) {
    return (0, _utils.install)(['react', 'react-dom'], { args: args, check: true }, cb);
  }, function (cb) {
